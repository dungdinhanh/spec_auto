#!/bin/bash
# v5 AARL: MULTI-BLOCK contamination, N=3 consecutive per rejection block,
# up to 9 cumulative (3 blocks of 3) per step. Comparator to N=5/total=10.
set -e
...
OUT=$DATA/runs/aarl_v5_multiblock_N3_total9_sharon1
mkdir -p $OUT

cd /home/ubuntu/katana_transfer/code
torchrun --nproc_per_node=8 --master_port=29682 \
