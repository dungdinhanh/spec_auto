#!/bin/bash
# v3 Option B (w_cons=0.1) on sharon1 GPUs 0-3.
# Same as winning Option A but with rule-based meta-action consistency reward (gentle weight).
...
torchrun --nproc_per_node=4 --master_port=29614 \
    ...
    --output_dir /home/ubuntu/local_data/runs/rl_v3_optB_ref_lr1e-6_N3_wcons0.1 \
...
echo "DONE rl_v3_optB_ref_lr1e-6_N3_wcons0.1 $(date)"
