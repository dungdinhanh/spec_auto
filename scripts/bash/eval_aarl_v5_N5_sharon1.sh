#!/bin/bash
# Eval v5 N=5 multiblock AARL ckpts vs init on val/test.
set -e
...
S15=$DATA/runs/aarl_v5_multiblock_N5_total10_sharon1/draft_step_1500.pt
FIN=$DATA/runs/aarl_v5_multiblock_N5_total10_sharon1/draft_final.pt

OUT=$DATA/runs/aarl_v5_multiblock_N5_total10_sharon1/_eval
mkdir -p $OUT
