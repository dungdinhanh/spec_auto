#!/bin/bash
# AARL on top of warm SFT v5 partial-blocks 1D (val 5.153 / test 4.617).
# Same recipe as the prior Option-A ref-anchor run (lr=1e-6, K=5, N=3, ref-anchor),
# only the init draft changes. Runs on sharon1 GPUs 4-7 (v3 3D EAGLE-3 on 0-3).
set -e
...
torchrun --nproc_per_node=4 --master_port=29635 \
    ...
    --output_dir /home/ubuntu/local_data/runs/aarl_v5partial_K5_refAnchor \
