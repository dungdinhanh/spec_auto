#!/bin/bash
# 4-GPU parallel eval of K=25 saved ckpts (8 topk + draft_final = 9 total).
# val_v3 (300) + test_v3 (200). Output to rl_v2_N5_k25_eval/.
# Runs on GPUs 4-7 (focused-CE is on GPUs 0-3).
set -e

LOCAL=/home/ubuntu/local_data
SCRIPTS=/home/ubuntu/katana_transfer/code/scripts
SPLITS=/home/ubuntu/katana_transfer/splits
OUTDIR=$LOCAL/runs/rl_v2_N5_k25_eval
mkdir -p "$OUTDIR"
...
K25=$LOCAL/runs/rl_v2_N5_k25

CK_GPU4=( $K25/draft_final.pt $K25/draft_step_500.pt $K25/draft_step_750.pt )
CK_GPU5=( $K25/draft_step_1250.pt $K25/draft_step_1500.pt )
CK_GPU6=( $K25/draft_step_2000.pt $K25/draft_step_2250.pt )
CK_GPU7=( $K25/draft_step_2500.pt $K25/draft_step_3500.pt )
