#!/bin/bash
# Template — placeholders 1e-6 5 rl_v3_optA_ref_lr1e-6_N5 29624 4,5,6,7
...
torchrun --nproc_per_node=4 --master_port=29624 \
    ...
    --output_dir /home/ubuntu/local_data/runs/rl_v3_optA_ref_lr1e-6_N5 \
...
echo "DONE rl_v3_optA_ref_lr1e-6_N5 $(date)"
