#!/bin/bash
# Template — placeholders 1e-6 2 rl_v3_optA_ref_lr1e-6_N2 29623 0,1,2,3
...
torchrun --nproc_per_node=4 --master_port=29623 \
    ...
    --output_dir /home/ubuntu/local_data/runs/rl_v3_optA_ref_lr1e-6_N2 \
...
echo "DONE rl_v3_optA_ref_lr1e-6_N2 $(date)"
