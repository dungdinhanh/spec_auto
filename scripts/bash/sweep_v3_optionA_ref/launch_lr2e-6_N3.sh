#!/bin/bash
# Template — placeholders 2e-6 3 rl_v3_optA_ref_lr2e-6_N3 29622 4,5,6,7
...
torchrun --nproc_per_node=4 --master_port=29622 \
    ...
    --output_dir /home/ubuntu/local_data/runs/rl_v3_optA_ref_lr2e-6_N3 \
...
echo "DONE rl_v3_optA_ref_lr2e-6_N3 $(date)"
