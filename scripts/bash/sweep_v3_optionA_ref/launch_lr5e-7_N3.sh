#!/bin/bash
# Template — placeholders 5e-7 3 rl_v3_optA_ref_lr5e-7_N3 29621 0,1,2,3
...
torchrun --nproc_per_node=4 --master_port=29621 \
    ...
    --output_dir /home/ubuntu/local_data/runs/rl_v3_optA_ref_lr5e-7_N3 \
    --num_epochs 2 --lr 5e-7 --kl_weight 0.02 \
    --k_samples 5 --k_chunk_size 5 --temperature 1.0 \
    --w_traj 1.0 --w_cons 0.0 --w_text 0.5 \
    --contamination_N 3 \
    --anchor_source ref \
    --log_interval 5 --save_interval 500 --no_wandb
echo "DONE rl_v3_optA_ref_lr5e-7_N3 $(date)"
