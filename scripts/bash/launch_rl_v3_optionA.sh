#!/bin/bash
# v3 Option A: w_cons=0 — drop r_cons. Reward = w_traj·(-MSE) + w_text·token_overlap.
...
exec torchrun --nproc_per_node=4 --master_port=29611 \
    ...
    --output_dir /mnt/resv-harry-6f72s/dungda/runs/rl_v3_optionA_K5 \
    ...
    --wandb_run_name rl_v3_optionA_K5_w_traj1_w_text0p5
