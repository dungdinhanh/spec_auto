#!/bin/bash
# v7 L=4 variant B — 70% full mask + 30% discrete-mid {4,8,11}, position 1 ALWAYS masked.
...
RUN=dflash_L4_lr1e-4_ep50_bs16_warm_v7_varB_sharon1
