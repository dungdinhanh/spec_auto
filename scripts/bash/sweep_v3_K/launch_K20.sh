#!/bin/bash
# v3 Option A with --anchor_source ref, K=20, k_chunk_size=10.
...
torchrun --nproc_per_node=4 --master_port=29627 \
    ...
    --output_dir /home/ubuntu/local_data/runs/rl_v3_optA_ref_K20 \
...
echo "DONE rl_v3_optA_ref_K20 $(date)"
