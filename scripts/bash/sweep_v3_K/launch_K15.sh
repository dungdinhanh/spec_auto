#!/bin/bash
# v3 Option A with --anchor_source ref, K=15, k_chunk_size=5.
...
torchrun --nproc_per_node=4 --master_port=29626 \
    ...
    --output_dir /home/ubuntu/local_data/runs/rl_v3_optA_ref_K15 \
    --num_epochs 2 --lr 1e-6 --kl_weight 0.02 \
    --k_samples 15 --k_chunk_size 5 --temperature 1.0 \
    --w_traj 1.0 --w_cons 0.0 --w_text 0.5 \
    --contamination_N 3 \
    --anchor_source ref \
    --log_interval 5 --save_interval 500 --no_wandb
echo "DONE rl_v3_optA_ref_K15 $(date)"
