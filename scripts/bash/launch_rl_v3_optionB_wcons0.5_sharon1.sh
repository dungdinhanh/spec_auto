#!/bin/bash
# v3 Option B (w_cons=0.5) on sharon1 GPUs 4-7.
# Stronger consistency weight to test whether r_cons actually shifts behavior.
...
torchrun --nproc_per_node=4 --master_port=29615 \
